...
export default function ServicePage() {
  ...
  const [faqList, setFaqList] = useState<FAQItem[]>([
    ...
    {
      question: '怎么充值？',
      answer: '登录账号后进入存款页面，选择您要的存款支付方式并输入金额，根据页面提示进行USDT充值或者人民币充值，交易完成后充值金额将会自动存入汇赢娱乐账户中。',
      expanded: false
    },
    {
      question: '游戏结束后如何提现？',
      answer: '登录账号后进入取款页面，输入取款金额（第一次取款须绑定汇赢娱乐卡包）选择对应卡包提取款，确认取款后约10-20分钟内转入您的指定取款账户。',
      expanded: false
    }
    // {
    //   question: '提币到账如何变现？',
