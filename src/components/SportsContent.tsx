...
export function SportsContent() {
  ...
  const sprotListData = [
        ...
        },
        {
            ...
            "game_type": 5,
            "game_code": 0,
            "mobile_pic": "/images/week/sbo.jpg",
            "tags": "",
            "params":  {gameCode: '0', gameType: 5},
            "platform_name": "SBO",
            "weight": 11,
        ...
        },
        {
            ...
            "game_type": 5,
            "game_code": 0,
            "mobile_pic": "/images/week/xiaojin.jpg",
            "tags": "",
            "params":  {gameCode: '0', gameType: 5},
            "platform_name": "XJ",
            "weight": 10,
        ...
        },
        {
            ...
            "game_type": 5,
            "game_code": 0,
            "mobile_pic": "/images/week/sansheng.jpg",
            "tags": "",
            "params":  {gameCode: '0', gameType: 5},
            "platform_name": "SS",
            "weight": 10,
    ...
    <>
      ...
      <div className="sports-content-wrapper">
        ...
        <div className="sports-images-grid">
          {(sprotListData.length > 0 ? sprotListData.slice(0, 6).map((game, index) => ({
            id: index + 1,
